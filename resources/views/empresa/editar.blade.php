    ...
    @endif
		<div class="panel panel-default">
			...
			<div class="panel-body">
				{!!Form::model($empresa, ['route'=>['empresa.update', $empresa->ruc], 'class'=>'form-horizontal', 'method'=>'put'])!!}
					<div class="form-group">
            {!!Form::label('RUC:', null, array('class'=>'col-sm-3 hidden-xs control-label'))!!}
            <div class="col-xs-12 col-sm-7 col-md-6 col-lg-4">
              {!!Form::text('ruc', null, array('class'=>'form-control input-sm', 'placeholder'=>'RUC', 'required'=>'', 'id'=>'ruc'))!!}
            </div>
          </div>
          <div class="form-group">
            {!!Form::label('Afiliado:', null, array('class'=>'col-sm-3 hidden-xs control-label'))!!}
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
              {!!Form::text('nombre', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'RAZÓN SOCIAL', 'required'=>'', 'id'=>'nombre'))!!}
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
              {!!Form::text('representante', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'REPRESENTANTE', 'required'=>'', 'id'=>'representante'))!!}
            </div>
          </div>
          <div class="form-group">
