  ...
  <div class="col-xs-12 col-sm-12 col-md-8 col-lg-10 col-md-offset-2 col-lg-offset-1">
    ...
    <div class="panel panel-default table-responsive">
      <div class="panel-heading">
        <h3 class="panel-title">Todos los Clientes <span>empresas</span></h3>
      </div>
      <div class="panel-body">
        <p>Tabla con todos los clientes</p>
      </div>
      <div class="table-responsive">
        <table id="grid-data" class="table table-bordered table-responsive" id="empresas" cellspacing="0" width="100%">
          <thead>
            <tr>
              <th data-column-id="ruc" data-order="asc" data-identifier="true">RUC</th>
              <th data-column-id="razon">RAZON SOCIAL</th>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content" style="background-color: #FF3737">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">Borrar Empresa <span class="ruc"></span> </h4>
                </div>
                <div class="modal-body">
                  <p>Esta a punto de borrar la Empresa  y con eso todos los AFOCAT'S que fueron vendidos a esta Empresa.</p>
...
<script>
  $(function(){
    ...
    var grid = $("#grid-data").bootgrid({
      ...
      url: "{{url('/buscar-empresa')}}",
      formatters: {
          "commands": function (column, row) {
              return "<a class='btn btn-xs btn-info' href='empresa/"+row.ruc+"'> <i class='fa fa-eye' aria-hidden='true'></i> Ver</a> " +
                "<a class='btn btn-xs btn-warning' href='empresa/"+row.ruc+"/edit'> <i class='fa fa-pencil' aria-hidden='true'></i> Editar</a> " +
                "<button class='btn btn-danger btn-xs command-delete' data-ruc='"+row.ruc+"'>" +
