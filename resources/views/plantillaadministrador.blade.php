...
$cumpleanios = DB::table('afoc_personas')->whereDate('nacimiento', date('Y-m-d'))->get();
 ?>
<!DOCTYPE html>
<html lang="es">
	<head>
        ...
        <div class="navbar-header">
          ...
          <a href="/" class="navbar-brand">
          	{!!Html::image('imagenes/logo.png', 'León de Huánuco', array('height'=>'30', 'width'=>'30', 'class'=>'img-responsive'))!!}
				...
				<div class="navbar-header">
          <a href="{{url('administrador')}}" class="navbar-brand">
          	ADMINISTRADOR
          </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="{{url('usuario/create')}}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo</a></li>
                <li><a href="{{url('usuario')}}"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Buscar</a></li>
              </ul>
            </li>
          </ul>
          <ul class="nav navbar-nav">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#"><span class="glyphicon glyphicon-gift" aria-hidden="true"></span> {{count($cumpleanios)}} Clientes Cumplen años hoy</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span> {{count($porvencer)}} CAT's vencen esta semana</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span> {{count($vencidos)}} CAT's vencieron</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
