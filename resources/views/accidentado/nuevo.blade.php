  ...
  <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {!!Form::open(['url'=>'accidentado', 'class'=>'form-horizontal'])!!}
          <div class="form-group">
            {!!Form::label('Código del Accidente:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
              {!!Form::text('accidente_id', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'CÓDIGO DEL ACCIDENTE',
          ...
          <div class="form-group">
            ...
            <div class="col-xs-4 col-sm-8 col-md-8 col-lg-8">
              {!!Form::text('dni', null, array('class'=>'form-control input-sm dni', 'placeholder'=>'DNI', 'required'=>'', 'id'=>'dni'))!!}
            </div>
          </div>
          <div class="form-group">
            {!!Form::label('Nombre y Apellidos:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-8 col-md-8 col-lg-8">
              {!!Form::text('nombre', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'NOMBRE Y APELLIDOS', 'required'=>''))!!}
            </div>
          </div>
          <div class="form-group">
            {!!Form::label('Forma de Pago:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-8 col-md-8 col-lg-8">
              {!!Form::text('forma_pago', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'FORMA DE PAGO', 'required'=>''))!!}
            </div>
          </div>
          <div class="form-group">
            {!!Form::label('A-82:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-8 col-md-8 col-lg-8">
              {!!Form::text('a_82', null, array('class'=>'form-control input-sm monto', 'placeholder'=>'A-82', 'required'=>''))!!}
            </div>
          </div>
          <div class="form-group">
            {!!Form::label('Cuenta A-82:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-8 col-md-8 col-lg-8">
              {!!Form::text('cuenta_a_82', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'CUENTA A-82', 'required'=>''))!!}
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-offset-4 col-sm-8">
              {!!Form::button('Guardar y Volver', ['class'=>'btn btn-primary btn-sm', 'name'=>'continuar', 'value'=>'1', 'type'=>'submit'])!!}
              {!!Form::button('Guardar y Terminar', ['class'=>'btn btn-warning btn-sm pull-rigth', 'name'=>'terminar', 'value'=>'1',
                'type'=>'submit'])!!}
            </div>
           </div>
        {!!Form::close()!!}
