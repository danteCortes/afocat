        ...
        <div class="col-xs-12">
          <div class="panel panel-default">
            <div class="panel-body">
              {!!Form::open(['url'=>'subir-padron', 'class'=>'form-inline', 'enctype'=>'multipart/form-data'])!!}
                <div class="form-group">
                  {!!Form::label('Padrón:', null, ['class'=>'control-label'])!!}
                  {!!Form::file('padron', null, ['class'=>'form-control input-sm', 'required'=>'', 'id'=>'padron'])!!}
                </div>
                {!!Form::button('Buscar', ['class'=>'btn btn-primary btn-sm', 'type'=>'submit', 'id'=>'buscar'])!!}
              {!!Form::close()!!}
            </div>
          </div>
        </div>
