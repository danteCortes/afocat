  ...
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">Exportar a excel SUNAT</h3>
      </div>
      <div class="panel-body">
        <p>Ingresar mes y año</p>
        {!!Form::open(['url'=>'excel', 'class'=>'form-horizontal'])!!}
        {{ csrf_field() }}
          ...
          <div class="form-group">
            <div class="col-sm-offset-4 col-sm-8">
              {!!Form::submit('Padrón SUNAT', ['class'=>'btn btn-primary btn-sm'])!!}
            </div>
           </div>
        {!!Form::close()!!}
      </div>
  ...
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        {!!Form::open(['url'=>'exportar-sunat-rango', 'class'=>'form-inline'])!!}
        {{ csrf_field() }}
          <div class="form-group">
          ...
          <div class="form-group">
            {!!Form::submit('Padrón SUNAT', ['class'=>'btn btn-danger btn-sm'])!!}
           </div>
        {!!Form::close()!!}
      </div>
    </div>
