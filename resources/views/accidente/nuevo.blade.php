  ...
  <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">Nuevo Accidente</h3>
      </div>
      <div class="panel-body">
        <p>Ingresar los datos del Accidente</p>
        {!!Form::open(['url'=>'accidente', 'class'=>'form-horizontal', 'method'=>'post'])!!}
          <div class="form-group">
            {!!Form::label('Placa*:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
              {!!Form::text('placa', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'PLACA', 'required'=>'', 'id'=>'placa'))!!}
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-4">
              {!!Form::text('provincia', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'PROVINCIA',
                'required'=>''))!!}
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-3 col-lg-4">
              {!!Form::text('zona', null, array('class'=>'form-control input-sm mayuscula', 'placeholder'=>'ZONA GEOGRÁFICA',
                'required'=>''))!!}
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
              {!!Form::text('ocurrencia', null, array('class'=>'form-control input-sm', 'placeholder'=>'OCURRENCIA', 'required'=>'', 'id'=>'ocurrencia'))!!}
            </div>
          </div>
          <div class="form-group">
            {!!Form::label('Fecha de Notificación:', null, array('class'=>'col-sm-4 hidden-xs control-label'))!!}
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
              {!!Form::text('notificacion', null, array('class'=>'form-control input-sm', 'placeholder'=>'NOTIFICACIÓN', 'id'=>'notificacion'))!!}
            </div>
          </div>
          <div class="form-group">
